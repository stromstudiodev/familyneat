...
(() => {
 ...
 function renderizarObjetivos(docs) {
  ...
  /* ================================================================
     ...
     ================================================================ */
  // Reutiliza comprimirImagen() para recortar la foto a un cuadrado antes
  // de guardarla temporalmente en memoria (avatarImagenAdultoTemp), a la
  // espera de que el adulto pulse "Continuar" (o "Omitir por ahora").
  function inicializarLogoAdulto() {
    ...
    inputArchivo?.addEventListener('change', async (evento) => {
      ...
      try {
        avatarImagenAdultoTemp = await comprimirImagen(archivo);
        if (preview) {
          preview.style.backgroundImage = `url(${avatarImagenAdultoTemp})`;
